...
const Home_Destination = () => {
  const [cardIndex, setCardIndex] = useState(100);
  ...
  return (
    <div className="poppins flex flex-col py-10 lg:my-20 mt-0 mb-20 relative overflow-hidden lg:overflow-visible">
      <div className="text-white text-center space-y-5 py-5">
        ...
        >
          <Image
            width={100}
            height={100}
            src="https://i.ibb.co.com/nDCNBSC/planepath.png"
            alt=""
            priority
