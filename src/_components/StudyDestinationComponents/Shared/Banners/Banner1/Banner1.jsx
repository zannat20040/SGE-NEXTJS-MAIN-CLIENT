...
const Banner1 = ({ bannerTitle, bannerDescription }) => {
  const [bgHover, setBgHover] = useState(0);

  return (
    <div onMouseEnter={() => setBgHover(1)} onMouseLeave={() => setBgHover(0)}>
      <div className="relative w-full mx-auto flex flex-col items-center justify-center">
        <div className="w-full">
          {bgHover === 1 ? (
            <Image
              ...
              src="https://i.ibb.co.com/xDWsG60/UK-Hero-Hover-BG-2.png"
              alt=""
            />
          ) : (
            <Image
              ...
              height={100}
              className="xl:h-[700px] rounded-3xl w-full"
              src="https://i.ibb.co.com/TcSds2P/UK-Hero-Hover-BG-1.png"
              alt=""
            />
          )}
        </div>
        <div className="absolute bottom-0 max-w-7xl mx-auto">
          <Image
            ...
            src="https://i.ibb.co.com/n1P7qZJ/UK-Hero-Hover-1.png"
            alt=""
          />
        </div>
