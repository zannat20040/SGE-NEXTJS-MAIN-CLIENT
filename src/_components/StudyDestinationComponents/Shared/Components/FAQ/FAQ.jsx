      ...
      <div className="mx-auto md:max-w-screen-xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-y-5 lg:flex-row lg:justify-between mx-auto">
          ...
          {details?.length > 0 ? (
                ...
                >
                  {details?.map((item, index) => (
                    ...
                    >
                      ...
                      >
                        <h5 className="text-base md:text-lg text-left break-words ">
                          {item.question}
                        </h5>
                        <svg
                      ...
                      >
                        <p className="text-sm md:text-base font-normal break-words">
                          {item.answer}
                        </p>
                      </div>
                    </div>
            ...
            <p className="italic text-center text-lg">No frequently question available</p>
          )}
        </div>
      </div>
    </div>
