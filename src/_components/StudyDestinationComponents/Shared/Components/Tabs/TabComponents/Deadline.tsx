...
const Deadline = ({ country }:{country:string}) => {
  return (
      ...
      <div className="flex w-full text-[#181A1B] items-center lg:flex-row flex-col">
        <div className="lg:w-[70%] w-full">
          ...
          <p className="text-xl font-medium text-center mx-auto mt-5">
            You need to start preparing your application a minimum of 9-10
            months in advance before the commencement of your program.
          </p>
        </div>
